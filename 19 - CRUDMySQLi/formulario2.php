...
<body>
    ...
    ?>
        <p>
            ...
            <label>Nombre:</label>
            <input type="text" name ="nombre" value = <?php echo $datosCli['nCli'];?>><br>
            <label>Apellido:</label>
            <input type="text" name ="apellido" value = <?php echo $datosCli['aCli'];?>><br>
            <label>Dirección</label>
            <input type="text" name ="dire" value =<?php echo $datosCli['dirCli'];?>><br>
        </p>
